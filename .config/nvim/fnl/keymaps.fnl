...
(vim.api.nvim_set_keymap :n :<C-s> :<cmd>Ex<CR> {:desc "Files Tree"})
...
(vim.api.nvim_set_keymap :n :<leader>sn "<cmd>Pick cli command={\"fd\" \"-H\" \".\" \"/home/joaquin/.config/nvim/\"}<CR>" {:desc "[S]earch [N]eovim files"})
(vim.api.nvim_set_keymap :n :<leader>sc "<cmd>Pick cli command={\"fd\" \"-H\" \".\" \"/home/joaquin/.dotfiles/\"}<CR>" {:desc "[S]earch [C]onfiguration"})
