...
(vim.keymap.set :n :\ "<cmd>lua Snacks.explorer()<CR>"
                {:desc "File Tree"})
...
(vim.keymap.set :n :<leader>sn "<cmd>lua Snacks.picker.files({cwd = '/home/joaquin/.dotfiles/.config/nvim/', hidden = true})<CR>" {:desc "[S]earch [N]eovim files"})
(vim.keymap.set :n :<leader>sm "<cmd>lua Snacks.picker.man()<CR>" {:desc "[S]earch [M]an pages"})
(vim.keymap.set :n :<leader>sc "<cmd>lua Snacks.picker.files({cwd = '/home/joaquin/.dotfiles/', hidden = true})<CR>" {:desc "[S]earch [C]onfiguration"})
